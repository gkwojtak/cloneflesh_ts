...
export const socialMediaProfiles = [
    ...
    { title: 'Instagram', href: 'https://www.instagram.com/cloneflesh/', icon: InstagramIcon },
]
...
export function SocialMedia({
    ...
    return (
        <ul
            ...
            className={clsx(
                'flex gap-x-10',
                invert ? 'text-teal-800' : 'text-neutral-950',
                className,
            )}
        >
            {socialMediaProfiles.map((socialMediaProfile) => (
                <li key={socialMediaProfile.title}>
                    <Link
                        ...
                        className={clsx(
                            'transition',
                            invert ? 'hover:text-teal-900' : 'hover:text-slate-900',
                        )}
                    >
